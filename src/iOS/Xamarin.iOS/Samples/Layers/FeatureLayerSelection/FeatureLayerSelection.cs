...
namespace ArcGISRuntimeXamarin.Samples.FeatureLayerSelection
{
    ...
    public class FeatureLayerSelection : UIViewController
    {
        ...
        {
            this.Title = "Feature Layer Selection";
        }
        ...
        private async void OnMapViewTapped(object sender, GeoViewInputEventArgs e)
        {
            ...
            var selectionEnvelope = new Envelope(e.Location.X - mapTolerance, e.Location.Y - mapTolerance, e.Location.X + mapTolerance, e.Location.Y + mapTolerance, _myMapView.Map.SpatialReference);
